    ...
    NavHost(navController = navController, startDestination = startDestination) {
        ...
        navigation(startDestination = "main", route = "main_graph") {
            ...
            composable(
                ...
                val postId = backStackEntry.arguments?.getString("postId") ?: ""
                PostDetailScreen(postId = postId, navController = navController, appViewModel = appViewModel)
            }
            ...
            composable("profile") { ProfileScreen(navController = navController, appViewModel = appViewModel) }
            composable("notifications") { NotificationScreen(navController = navController, appViewModel = appViewModel) }
            composable("settings") { SettingsScreen(navController = navController, appViewModel = appViewModel) }
        }
    }
}